...
<section id="content">
    ...
    <div class="page page-forms-validate">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        {!! Form::open(['url' => route('Storeupload'),'method' => 'post','enctype'=>'multipart/form-data','class'=>'form-validate-jquery','data-parsley-validate','name'=>'form2','role'=>'form','id'=>'form2']) !!}
                        @csrf
                        <fieldset>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::file('staff_id_no', null, ['class' => 'form-control','placeholder'=>'Staff id No','id'=>'staff_id_no','required'=>'required']) !!}
                                    </div>
                                </div>
                            </div>
                        </fieldset>
        ...
        @foreach ($photos as $photo)
            <div class="photo">
                <img src="{{ Storage::disk('do_spaces')->url($photo->file) }}" />
                <p>{{ $photo->file }}</p>
            </div>
        @endforeach

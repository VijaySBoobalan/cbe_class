...
function drawMathsText(context, textArray, fontSize, horizPos, vertPos, algText, textLoc, horizAlign, vertAlign, textColor, mode, backColor, bold, italic, fontName, selected, sf, backgroundColor, fracScale, algPadding) {
					...
					if (splitText[section].indexOf('<<') == 0) {
						...
						for (r = 0; r < splitText[section].length; r++) {
							...
							if (mode2 == 'draw') {
								...
								textLoc[q].push({left: leftPoint, top:t, width: context.measureText(char).width + leftPadding + rightPadding, height:h, fontSize: fontSize * 0.85, char:char});
								...
								if (splitText[section][r] !== String.fromCharCode(0x21F4) && splitText[section][r] !== br) context.fillText(char, leftPoint + leftPadding, charCenter + fontSize / 20);
							}
							...
							if (splitText[section][r] == String.fromCharCode(0x21F4)) { // if character is a tab
								...
								leftPoint += context.measureText(char).width + leftPadding + rightPadding;
							}

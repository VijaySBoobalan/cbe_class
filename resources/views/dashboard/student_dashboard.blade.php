			...
			<div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Today Classes</h1> &nbsp ({{ date('m/d/Y') }})
                        </div>
                        <!-- /tile header -->
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile">
                        <!-- tile header -->
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Tomorrow Classes</h1> &nbsp ({{ date("m/d/Y", time() + 86400) }})
                        </div>
                        <!-- /tile header -->
                ...
                <div class="col-md-6">
                    ...
                    <section class="tile widget-message">
                        ...
                        <div class="tile-body table-custom">
                            ...
                            <div class="table-responsive">
                                <table class="table table-custom" id="StudentAttendance">
                                    <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>Date</th>
...
@section('script')
    ...
    <script>
        ...
        function CheckDate() {
            ...
            if(checkValid == true){
                if (table != "") {
                    ...
                    table = $('#StudentAttendance').DataTable({
                        processing: true,
                        serverSide: false,
                        responsive: true,
                        autoWidth: false,
                        ...
                        dom: '<"datatable-header"><"datatable-scroll-wrap"t><"datatable-footer">',
                        ajax: {
                            url: "{{ route("getStudentAttendanceDetails") }}",
                            "type": 'GET',
                            data: function (d) {
        ...
        $(window).load(function(){
            ...
            var plot = $.plot($("#Export-analysis"), data, options);

                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('class',$staffSubjectAssign->pluck('class','class') ,null, ['onchange'=>'getSection(this.value);','class' => 'form-control chosen-select taken_class','placeholder'=>'Select Class','id'=>'class','required'=>'required']) !!}
                                        </div>
                                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        $("#videos_filter_form_btn").click(function() {
            ...
            axios.post("{{ url('filterVideos') }}", formFileds).then(response => {

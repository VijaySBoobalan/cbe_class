<?php
    $MERCHANT_KEY = "ggnFh69t"; // add your id
    $SALT = "kuZFBpp3Uz"; // add your id
    ...
    $posted = array(
        ...
        'surl' => URL::to('/api')."/".'subscribe-response',
        'furl' => URL::to('/api')."/".'subscribe-cancel',
  ...
  <body onload="submitPayuForm()">
    Processing.....
        <form action="<?php echo $action; ?>" method="post" name="payuForm"><br />
            ...
            <input type="hidden" name="amount" value="{{ $datas['amount'] }}" /><br />
            ...
            <input type="hidden" name="productinfo" value="{{ $datas['productinfo'] }}"><br />

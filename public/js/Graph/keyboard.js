...
function createKeyboard(object) {
	...
	var backColor = object.backColor || '#493d55';
	...
	var contextInstance = canvasInstance.getContext('2d');
	roundedRect(contextInstance, 3, 3, 44, 44, 8, 6, '#000', '#FFF');
	roundedRect(contextInstance, 9, 9, 8, 8, 3, 2, '#000', '#000');
	roundedRect(contextInstance, 21, 9, 8, 8, 3, 2, '#000', '#000');
	roundedRect(contextInstance, 33, 9, 8, 8, 3, 2, '#000', '#000');
	roundedRect(contextInstance, 9, 21, 8, 8, 3, 2, '#000', '#000');
	roundedRect(contextInstance, 21, 21, 8, 8, 3, 2, '#000', '#000');
	roundedRect(contextInstance, 33, 21, 8, 8, 3, 2, '#000', '#000');
	roundedRect(contextInstance, 9, 33, 8, 8, 3, 2, '#000', '#000');
	roundedRect(contextInstance, 21, 33, 8, 8, 3, 2, '#000', '#000');
	roundedRect(contextInstance, 33, 33, 8, 8, 3, 2, '#000', '#000');	

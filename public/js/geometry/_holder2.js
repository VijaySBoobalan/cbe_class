...
if (scriptsToLoad.includes('clone.js') == false) scriptsToLoad.unshift(public_path+'/public/js/geometry/clone.js');
if (scriptsToLoad.includes('_draw3.js') == false) scriptsToLoad.push(public_path+'/public/js/geometry/_draw3.js');
...
var mainCanvasFillStyle =  '#e3dee8';
...
function loadScript(url, callback, errorCallback, index) {
	...
	var url2 = typeof cacheVersion === 'string' ? url + '?' + Date.now() : url;
	script.src = url2;
	script.index = index;
